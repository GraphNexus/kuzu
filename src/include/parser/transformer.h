...
private:
    ...
    std::unique_ptr<Statement> transformCreateExternalNodeTable(CypherParser::KU_CreateExternalNodeTableContext& ctx);
    ...
    std::string transformPrimaryKey(CypherParser::KU_PrimaryKeyContext& ctx);

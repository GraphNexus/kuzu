...
struct EnableMVCCSetting {
    static constexpr auto name = "enable_multi_writes";
    static constexpr auto inputType = common::LogicalTypeID::BOOL;
    static void setContext(ClientContext* context, const common::Value& parameter) {
...
struct SkipFlushCheckpointRecordSetting {
    static constexpr auto name = "_skip_flush_checkpoint_record";
    static constexpr auto inputType = common::LogicalTypeID::BOOL;
    static void setContext(ClientContext* context, const common::Value& parameter) {
        parameter.validateType(inputType);
        context->getDBConfigUnsafe()->skipFlushCheckpointRecord = parameter.getValue<bool>();
    }
    static common::Value getSetting(const ClientContext* context) {
        return common::Value(context->getDBConfig()->skipFlushCheckpointRecord);
    }
};

struct SkipOverwriteWALVersionFilesSetting {
    static constexpr auto name = "_skip_overwrite_wal_version_files";
    static constexpr auto inputType = common::LogicalTypeID::BOOL;
    static void setContext(ClientContext* context, const common::Value& parameter) {
        parameter.validateType(inputType);
        context->getDBConfigUnsafe()->skipOverwriteWALVersionFiles = parameter.getValue<bool>();
    }
    static common::Value getSetting(const ClientContext* context) {
        return common::Value(context->getDBConfig()->skipOverwriteWALVersionFiles);
    }
};

struct SkipReplayShadowSetting {
    static constexpr auto name = "_skip_replay_shadow";
    static constexpr auto inputType = common::LogicalTypeID::BOOL;
    static void setContext(ClientContext* context, const common::Value& parameter) {
        parameter.validateType(inputType);
        context->getDBConfigUnsafe()->skipReplayShadow = parameter.getValue<bool>();
    }
    static common::Value getSetting(const ClientContext* context) {
        return common::Value(context->getDBConfig()->skipReplayShadow);
    }
};

struct SkipClearWALSetting {
    static constexpr auto name = "_skip_replay_shadow";
    static constexpr auto inputType = common::LogicalTypeID::BOOL;
    static void setContext(ClientContext* context, const common::Value& parameter) {
        parameter.validateType(inputType);
        context->getDBConfigUnsafe()->skipClearingWAL = parameter.getValue<bool>();
    }
    static common::Value getSetting(const ClientContext* context) {
        return common::Value(context->getDBConfig()->skipClearingWAL);
    }
};
